...
import profilePicture from "../assets/images/dindadummy.jpg";

function Aboutme() {
  return (
    <div className="pb-20">
      <h1 className="text-center text-3xl py-10">About Me</h1>
      <div className="about-me flex sm:flex-row flex-col items-center justify-center w-full">
        <div className="w-full sm:w-1/2 mx-3 text-justify">
          <h3 className="text-3xl sm:text-5xl font-bold my-2 text-left">
            Hello !
          </h3>
          <h2 className="sm:text-3xl text-lg ">I'm Dinda</h2>
          ...
          <p className="sm:text-2xl py-2 text-lg break-words ">
            I’m not really sure how old I was when i started learing
