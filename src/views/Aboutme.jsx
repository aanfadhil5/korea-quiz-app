  ...
  return (
    <div className="pb-20">
      ...
      <div className="about-me flex sm:flex-row flex-col items-center justify-center w-full">
        <div className="w-full sm:w-1/2 mx-3 text-justify pl-9">
          <h2 className="sm:text-2xl font-bold mb-3">
            hello
          </h2>
          <h2 className="ml-4 sm:text-3xl text-lg font-bold">I'm Dinda</h2>
          <h2 className="ml-4 sm:text-3xl text-lg font-bold">
            I am a student who love to learn!
          </h2>
          <h2 className="ml-4 sm:text-3xl text-xl font-bold">
            Especially in technology and programming
          </h2>
          <p className="ml-4 sm:text-xl py-2 text-lg break-words ">
